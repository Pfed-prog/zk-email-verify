    ...
    <Container>
      ...
      >
        <span style={{ color: "rgba(255, 255, 255, 0.7)" }}>
          ...
          and debugging this page, it is likely unstable. Due to download limits
          of incognito mode and non-chrome browsers, you must use Chrome to
          generate proofs right now. Our goal for March 2023 is to make this
          process 10x faster and smaller. If you wish to generate a ZK proof of
          Twitter badge, you must do these:
        </span>
        <NumberedStep step={1}>
          Send yourself a{" "}
          <a
            href="https://twitter.com/i/flow/password_reset"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <NumberedStep step={3}>
          Copy paste that into the box below. Note that we cannot use this to
          phish you: we do not know your password, and we never get this email
          info because we have no server at all. We are actively searching for a
          less sketchy email.
        </NumberedStep>
        <NumberedStep step={4}>
